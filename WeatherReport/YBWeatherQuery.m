...
-(NSDictionary *)QueryWeather:(NSString *)WithCityCode{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:SK_URL,WithCityCode]];
    ...
    url = [NSURL URLWithString:[NSString stringWithFormat:SK2_URL,WithCityCode]];
    ...
    url = [NSURL URLWithString:[NSString stringWithFormat:ALL_URL,WithCityCode]];
    data = [NSData dataWithContentsOfURL:url options:NSDataReadingUncached error:nil];
    json = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:nil];
